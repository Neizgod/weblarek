...
Обработчик: отправляет запрос на сервер с введенными данными и id выбранных товаров, очишает данные в корзине и customerData, вызывает модальное окно с информированием об успешной покупке.